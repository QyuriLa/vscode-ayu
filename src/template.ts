...
export default () => {
	return {
		...
		colors: {
			...
			// INPUT CONTROL
			'input.background': scheme.mirage.editor.bg.hex(),
			'input.border': scheme.mirage.ui.fg.alpha(0.27).hex(),
			'input.foreground': scheme.mirage.editor.fg.hex(),
			'input.placeholderForeground': scheme.mirage.ui.fg.alpha(0.5).hex(),
			'inputOption.activeBorder': scheme.mirage.common.accent.alpha(0.3).hex(),
			'inputOption.activeBackground': scheme.mirage.common.accent.alpha(0.2).hex(),
			'inputOption.activeForeground': scheme.mirage.common.accent.hex(),
			...
			// LISTS AND TREES
			'list.activeSelectionBackground': scheme.mirage.ui.selection.normal.hex(),
			...
			'list.focusOutline': scheme.mirage.common.accent.alpha(0.2).hex(),
			'list.highlightForeground': scheme.mirage.common.accent.hex(),
			'list.deemphasizedForeground': scheme.mirage.common.error.hex(),
			'list.hoverBackground': scheme.mirage.ui.selection.active.hex(),
			// 'list.hoverForeground': scheme.light.ui.fg.hex(),
			'list.inactiveSelectionBackground': scheme.mirage.ui.panel.bg.hex(),
			'list.inactiveSelectionForeground': scheme.mirage.ui.fg.hex(),
			...
			'editorWhitespace.foreground': scheme.dark.editor.indentGuide.active.alpha(0.7).hex(),
