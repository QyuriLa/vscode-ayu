...
export default () => {
	return {
		...
		colors: {
			...
			'statusBar.debuggingBackground': scheme.dark.syntax.constant.hex(),
			'statusBar.debuggingForeground': scheme.dark.editor.bg.hex(),
			...
			'statusBarItem.prominentForeground': scheme.light.ui.fg.hex(),
